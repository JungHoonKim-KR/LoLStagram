...
const Compare=({ isOpen, onClose })=>{
    ...
    const [summoner1,setSummoner1] = useState(JSON.parse(localStorage.getItem("searchedSummonerInfo")))
    const [summoner2,setSummoner2] = useState(JSON.parse(localStorage.getItem("mySummonerInfo")))
                    ...
                    <div className="summonerInfo">
                        <div id="summoner1">
                            <div className="tier-image">
                                <img src={require(`../images/tierImage/${summoner1.tier}.png`)} />
                            </div>
                        ...
                        <div id="summoner2">
                            <div className="tier-image">
                                <img src={require(`../images/tierImage/${summoner2.tier}.png`)} />
                            </div>
                            <div className="summoner">
                                ...
                                <div className="compareValue">
                                    <div className="compareItem" >{item.name}
                                        {item.value>0 &&
                                            ...
                                            <img className="upperImg" src={upperImg}/>
                                            </div>
                                        }
